...
namespace EntityOrientedCommunication.Server
{
    ...
    {
        private class ServerLoginAgent : LoginAgent, IMailDispatcher
        {
            #region data
            #region property
            public ServerOperator SOperator => Operator as ServerOperator;
            #endregion
            ...
            protected override void ProcessRequest(ref TMessage msg)
            {
                ...
                else if (msg.HasFlag(StatusCode.Letter))
                {
                    ...
                    else
                    {
                        ...
                        if (bSend)
                        {
                            ...
                            if (error == null)
                            {
                                error = server.manager.Deliver(letter);
                            }  // else error
                ...
                {
                    if (msg.HasFlag(StatusCode.Receiver))
                    {
